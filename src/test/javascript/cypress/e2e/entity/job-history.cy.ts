...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-05-17T19:36').blur().should('have.value', '2023-05-17T19:36');

      cy.get(`[data-cy="endDate"]`).type('2023-05-17T02:33').blur().should('have.value', '2023-05-17T02:33');
